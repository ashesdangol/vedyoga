  ...
  while ($mainQuery->have_posts()) {
    ...
    if(get_post_type() == 'post' OR get_post_type() == 'page'){
      array_push($mainResults['generalInfo'], array(
        ...
        'postFeaturedImage__Lg'=>get_the_post_thumbnail_url(0,'featuredImage__portrait--xl'),
        'postFeaturedImage__Med'=>get_the_post_thumbnail_url(0,'featuredImage__portrait'),
        'postFeaturedImage__Sm'=>get_the_post_thumbnail_url(0,'featuredImage__landscape'),
